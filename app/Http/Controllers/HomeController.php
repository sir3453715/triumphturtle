    ...
    public function updateToken(Request $request){
        ...
        if ($order){
            ...
            $mailData = [
                ...
                'msg'=>'您的訂單修改驗證碼為: '.$updateToken.'<br/><br/>請透過網站進行驗證，或點擊下方連結完成驗證手續:<br/><a target="_blank" href="'.route('tracking-captcha',['seccode'=>$order->seccode]).'">訂單修改驗證</a><br/><br/><span style="color: red;">注意: 如果此活動不是您本人操作，請停止操作並寫信至 service@joinmeship.com 或撥打客服專線 (02) 2978-0058 聯繫客服人員。</span>',
            ];
