...
<div class="main-wrapper">
    ...
    <section class="container cus-container">
            ...
            <div class="card">
                <div class="card-top">
                        ...
                        <div class="data-header-top">
                            ...
                            <div>
                                <div class="data-header-title cus-row">
                                    <p>訂單編號</p>
                                    <span class="cus-badge cus-badge-dark-gray">TS211001002</span>
                    ...
                    <div class="detail-info">
                        <p class="mb-3"><span class="data-label">主揪人:</span>Michael</p>
                    </div>
                </div>
        ...
        <div class="des-box des-box-blue">
            <ol>
                <li>請在<span>YYYY/MM/dd</span>前完成所有資料填寫，若設定完資料後有需要修改, 請點擊首頁訂單查詢查出訂單後再做資料修改</li>
                <li>運單將會發送到您設定個寄件人信箱，請列印出來後貼至箱上，並在入倉截止日前<span>YYYY/MM/dd</span>寄送到<a
