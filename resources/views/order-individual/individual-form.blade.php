...
<div class="main-wrapper">
    <section class="banner-wrapper">
        <div class="banner container">
            <div><img src="/storage/image/idividual-icon.svg" alt="個人寄送">
                <h1>個人寄送</h1>
            </div>
        </div>
    </section>
                        ...
                        <div class="item-wrapper">
                            ...
                            <div class="row mb-3 item-section">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control form-required" name="item_name[]" id="item_name" placeholder="請填寫英文" placeholder="請填寫英文">
                                </div>
