<!--form info Modal -->
<div class="modal modal-dark fade" id="info-modal" tabindex="-1" role="dialog" aria-labelledby="confirm-modal"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-left px-5">
                <h4>私人行李寄送:</h4>
                <p>進口人可以不用隨貨回台灣</p>
                <p class="mb-2">免稅額2000</p>
                <ol class="mb-3">
                    <li>個人身份正反面</li>
                    <li>個案委任書</li>
                </ol>
                <h4>行李後送:</h4>
                <p>寄件者需比行李提早回台灣(間隔不能超過6個月)</p>
                <p class="mb-3">免稅額20000</p>
                <p>回台時需準備下列資料給客服人員</p>
                <ol class="mb-3">
                    <li>身分證正反面影本</li>
                    <li>護照影本 (有您照片及出生年月日那頁)</li>
                    <li>電子機票</li>
                    <li>入境章影本</li>
                    <li>海關申報書 (搭機回台灣過海關時，請一定走紅線櫃台填寫"海關申報書"，並拍照傳送給客服即可)</li>
                </ol>
                <h4>商業目的:</h4>
                <p>進口貨物到台灣販售，需先提供商品資訊及貨量給客服確認相關進口規定。</p>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-left px-5 my-5">
                ...
                <p class="mb-3">本人利用奧瑞國際有限公司平台運送私人物品， 並承諾恪遵法律義務。 運送物依其性質，對於人或財產有致損害之虞者，本人於訂立契約前，應將其性質告知奧瑞國際有限公司，怠於告知者，對於因此所致之損害，應負賠償之責。
                <p class="mb-4">本人對於交運貨物之名稱、數量，或其包裝之種類、個數及標誌之通知，應向奧瑞國際有限公司保證其正確無訛，其因通知不正確所發生或所致之一切毀損、滅失及費用，由本人負賠償責任。</p>
                ...
                <p class="mb-4">此致<br>奧瑞國際有限公司<br>FF SOLUTION CO LTD.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 pl-0">
                <div class="footer-menu">
                    <ul
                        class="text-muted list-unstyled d-md-flex d-block justify-content-lg-start justify-content-center">
